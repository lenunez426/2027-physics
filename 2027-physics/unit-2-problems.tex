...
\begin{tikzpicture}
    \begin{axis}[height=6.5cm,width=7.5cm,
        ...
        \begin{pgfonlayer}{background}
            \addplot[fill=green!20,draw=none,domain=-3:-2,samples=100] {x^2 - 4} \closedcycle;
            \addplot[fill=red!20,draw=none,domain=-2:2,samples=100] {x^2 - 4} \closedcycle;
            \addplot[fill=green!20,draw=none,domain=2:3,samples=100] {x^2 - 4} \closedcycle;
        \end{pgfonlayer}
        \fi
    \end{axis}
\end{tikzpicture}
...
\begin{tikzpicture}
    \begin{axis}[height=6.5cm,width=7.1cm,
        ...
        \begin{pgfonlayer}{background}
            \addplot[fill=green!20,draw=none,domain=0:pi,samples=100] {{sin(deg(x))}} \closedcycle;
            \addplot[fill=red!20,draw=none,domain=pi:2*pi,samples=100] {{sin(deg(x))}} \closedcycle;
        \end{pgfonlayer}
    \end{axis}
\end{tikzpicture}
...
\begin{tikzpicture}
    \begin{axis}[height=6.5cm,width=7.5cm,
        ...
        \begin{pgfonlayer}{background}
            \addplot[fill=green!20,draw=none,domain=-3:3,samples=100] {exp(-x^2)} \closedcycle;
        \end{pgfonlayer}
    \end{axis}
\end{tikzpicture}
...
\begin{tikzpicture}
    \begin{axis}[height=6.5cm,width=7.5cm,
        ...
        \begin{pgfonlayer}{background}
            \addplot[fill=red!20,draw=none,domain=-2:-sqrt(3),smooth] {x^3 - 3*x} \closedcycle;
            \addplot[fill=green!20,draw=none,domain=-sqrt(3):0,smooth] {x^3 - 3*x} \closedcycle;
            \addplot[fill=red!20,draw=none,domain=0:sqrt(3),smooth] {x^3 - 3*x} \closedcycle;
            \addplot[fill=green!20,draw=none,domain=sqrt(3):2,smooth] {x^3 - 3*x} \closedcycle;
        \end{pgfonlayer}
    \end{axis}
\end{tikzpicture}
\end{minipage}
...
\begin{tikzpicture}
    \begin{axis}[height=6.5cm,width=7.5cm,
        ...
        \begin{pgfonlayer}{background}
            \addplot[fill=green!20,draw=none,domain=0.5:4,smooth] {1/x} \closedcycle;
        \end{pgfonlayer}
    \end{axis}
\end{tikzpicture}
...
\begin{tikzpicture}
    \begin{axis}[height=6.5cm,width=7.1cm,
        ...
        \begin{pgfonlayer}{background}
            \addplot[fill=green!20,draw=none,domain=0:sqrt(pi/2),smooth] {{cos(deg(x^2))}} \closedcycle;
            \addplot[fill=red!20,draw=none,domain=sqrt(pi/2):sqrt(3*pi/2),smooth] {{cos(deg(x^2))}} \closedcycle;
            \addplot[fill=green!20,draw=none,domain=sqrt(3*pi/2):2.5,smooth] {{cos(deg(x^2))}} \closedcycle;
        \end{pgfonlayer}
    \end{axis}
\end{tikzpicture}
...
\begin{tikzpicture}
    \begin{axis}[height=6.5cm,width=7.1cm,
        ...
        \begin{pgfonlayer}{background}
            \addplot[fill=red!20,draw=none,domain=0:5,smooth] {-x*exp(-x)} \closedcycle;
        \end{pgfonlayer}
    \end{axis}
\end{tikzpicture}
...
\begin{tikzpicture}
    \begin{axis}[height=6.5cm,width=7.5cm,
        ...
        \begin{pgfonlayer}{background}
            \addplot[fill=green!20,draw=none,domain=-3*pi:-2*pi,samples=25] {sin(deg(x))/x} \closedcycle;
            \addplot[fill=red!20,draw=none,domain=-2*pi:-pi,samples=25] {sin(deg(x))/x} \closedcycle;
            \addplot[fill=green!20,draw=none,domain=-pi:pi,samples=25] {sin(deg(x))/x} \closedcycle;
            \addplot[fill=red!20,draw=none,domain=pi:2*pi,samples=25] {sin(deg(x))/x} \closedcycle;
            \addplot[fill=green!20,draw=none,domain=2*pi:3*pi,samples=25] {sin(deg(x))/x} \closedcycle;
        \end{pgfonlayer}
    \end{axis}
\end{tikzpicture}
...
\begin{tikzpicture}
    \begin{axis}[height=6.5cm,width=7.1cm,
        ...
        \begin{pgfonlayer}{background}
            \addplot[fill=green!20,draw=none,domain=0:pi/2,samples=50] {exp(-x)*sin(deg(2*x))} \closedcycle;
            \addplot[fill=red!20,draw=none,domain=pi/2:pi,samples=50] {exp(-x)*sin(deg(2*x))} \closedcycle;
            \addplot[fill=green!20,draw=none,domain=pi:3*pi/2,samples=50] {exp(-x)*sin(deg(2*x))} \closedcycle;
        \end{pgfonlayer}
    \end{axis}
\end{tikzpicture}
