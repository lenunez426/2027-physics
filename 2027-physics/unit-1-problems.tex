...
\ifprintanswers
\textcolor{red}{$x$ is position, the location of an object on the number line. $\Delta x$ is displacement, net the change in position between initial and final points.}
\else
\fillwithlines{21mm}
\fi
...
\begin{tikzpicture}[y=1.2cm,x=1.8cm]
    ...
    \ifprintanswers
        \draw[red,ultra thick] (0,-0.5) -- (1,-0.5);
    \fi
\end{tikzpicture}
\hspace{5mm}
\begin{tikzpicture}[y=1.2cm,x=1.8cm]
...
\begin{tikzpicture}[y=1.2cm,x=1.8cm]
    ...
    \ifprintanswers
        \draw[red,very thick] (0,1) -- (0.8,0) -- (1,1);
    \fi
\end{tikzpicture}
\end{center}
...
\begin{solution}
\begin{equation*}
    \text{vector sum} = 2 + (-1) + 3 + (-5) + 3 = \boxed{2}
\end{equation*}
\end{solution}
...
\textit{Rank.}\quad \fillin[C, B, A][4cm]

\textit{Directions.} A: \fillin[$\rightarrow$][2em]\quad 
B: \fillin[$\rightarrow$][2em]\quad
C: \fillin[$\rightarrow$][2em]
\smallskip
...
\question
\textit{Rank.}\quad \fillin[B, C, A][4cm]

\textit{Directions.} A: \fillin[$\rightarrow$][2em]\quad 
B: \fillin[$\leftarrow$][2em]\quad
C: \fillin[$\rightarrow$][2em]
\smallskip
...
\question
\textit{Rank.}\quad \fillin[C, A, B][4cm]

\textit{Directions.} A: \fillin[$\leftarrow$][2em]\quad 
B: \fillin[$\leftarrow$][2em]\quad
C: \fillin[$\leftarrow$][2em]
\smallskip
...
\textit{Rank.}\quad \fillin[A, B, C][4cm]
