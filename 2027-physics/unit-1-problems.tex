...
\begin{multicols}{2}
\question
A car travels at a speed of 60 miles per hour. How far does it travel in half an hour?
...
\question
A car travels at a speed of 60 miles per hour. How far does it travel in one hour?
...
\question
A car travels at a speed of 60 miles per hour. How far does it travel in an hour and a half?
...
\question
Consider the distance and speed graphs below. How far does the object travel in half an hour?
...
\question
How far does the object travel in an hour and a half?
...
\question
How far does the object travel in half an hour?
...
\begin{questions}
\question 
An object's position and velocity vectors are $\vec{x} = \SI{2}{m}$ and $\vec{v} = -\SI{5}{m/s}$. In which direction is the object moving?


\question 
An object's position and velocity vectors are $\vec{x} = \SI{4}{m}$ and $\vec{v} = \SI{7}{m/s}$. In which direction is the object moving?

\question 
An object's position and velocity vectors are $\vec{x} = -\SI{12}{m}$ and $\vec{v} = \SI{23}{m/s}$. In which direction is the object moving?

\question 
An object's position and velocity vectors are $\vec{x} = -\SI{15}{m}$ and $\vec{v} = -\SI{6}{m/s}$. In which direction is the object moving?
