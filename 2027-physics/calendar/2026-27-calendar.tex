...
\newcommand{\dayreviewI}[1]{%
    \day{#1}{review the previous week's work}
}
...
\begin{calendar}
    ...
    \newunit{Unit 1: Constant Velocity}{
        magnitude, scalar, vector, component, tail, head
    } % 17
	\day{}{head-to-tail method, vector sum} % 18
	\day{}{position, motion, reference frame, one-dimensional motion, displacement, distance} % 19
	\day{}{speed, average speed, velocity, average velocity} % 20
	\day{}{motion map, position vs.\,time graph} % 21
	\wday{}{} % 22
	\wday{}{} % 23
	\dayreviewI{Monday Review} % 24
	\day{}{velocity vs.\,time graph} % 25
	\day{}{} % 26
	\day{}{} % 27
	\day{}{} % 28
	\blankday{}
