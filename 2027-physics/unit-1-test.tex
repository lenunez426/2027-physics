...
Then, they travel in one dimension with the motion shown in the graph below.
...
\begin{tikzpicture}
    ...
    \ifprintanswers
    \begin{pgfonlayer}{background}
        \fill[color=red!12] (0,-4) rectangle (5,0) node[black,pos=0.5] {$\Delta x$};
    \end{pgfonlayer}
    \fi
\end{axis}
\end{tikzpicture}
...
What is their displacement from the origin?

\begin{randomizechoices}
    \correctchoice 20 meters to the left of the origin
    \choice 20 meters to the right of the origin
    \choice 4 meters to the left of the origin
    \choice 4 meters to the right of the origin
\end{randomizechoices}
