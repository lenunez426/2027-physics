...
\newglossaryentry{slope}{
    name={slope},
    description={the ratio of the vertical change {\small ($\Delta y$)} to the horizontal change {\small ($\Delta x$)} between two points on a line}
}

\newglossaryentry{area}{
    name={area},
    description={the amount of space enclosed within a two-dimensional boundary}
}

\newglossaryentry{distance vs. time graph}{
    name={distance vs.\,time graph},
    description={a graph in which distance is plotted on the vertical axis and time is plotted on the horizontal axis}
}

\newglossaryentry{speed vs. time graph}{
    name={speed vs.\,time graph},
    description={a graph in which speed is plotted on the vertical axis and time is plotted on the horizontal axis}
}
...
\newglossaryentry{position}{
    name={position},
    description={the location of an object on a number line at a particular time}
}

\newglossaryentry{SI unit}{
    name={SI unit},
    description={a unit of measurement belonging to the International System of Units, the globally accepted standard system for scientific measurement}
}

\newglossaryentry{base SI unit}{
    name={base SI unit},
    description={a fundamental unit of measurement in the SI system from which all other units are derived}
}
...
\newglossaryentry{number line}{
    name={number line},
    description={a straight line on which each point corresponds to a real number, with positive numbers to the right and negative numbers to the left of zero}
}
...
\newglossaryentry{motion map}{
    name={motion map},
    description={a diagram that represents the position and velocity of an object at 1-second time intervals (or equal time intervals)}
}
...
\newglossaryentry{speed}{
    name={speed},
    description={the rate at which an object covers distance}
}
...
\newglossaryentry{velocity1}{
    name={velocity},
    description={the speed and direction of motion at an instant in time}
}
...
\newglossaryentry{time}{
    name={time},
    description={a measure of the progression of events from the past through the present to the future}
}

\newglossaryentry{time interval}{
    name={time interval},
    description={the difference between two points in time}
}

\newglossaryentry{position vector}{
    name={position vector},
    description={a vector starting at the origin and ending at an object's position}
}
...
\newglossaryentry{average acceleration}{
    ...
    description={change in velocity divided by the time during which the motion occurs}
}
...
\newglossaryentry{Galileo's law of odd numbers}{
    name={Galileo's law of odd numbers},
    description={the distances traveled by an object undergoing constant acceleration in successive equal time intervals are proportional to the odd numbers 1, 3, 5, 7\ldots}
}
...
\newglossaryentry{hang time}{
    name={hang time},
    description={the total amount of time an object remains in the air}
}

\newglossaryentry{air resistance}{
    name={air resistance},
    description={a force exerted by air on a moving object that opposes its motion}
}

\newglossaryentry{negligible}{
    name={negligible},
    description={too small to have a meaningful effect on a calculation or outcome}
}

\newglossaryentry{vertical velocity}{
    name={vertical velocity},
    description={the component of an object's velocity in the vertical direction}
}
...
\newglossaryentry{projectile}{
    name={projectile},
    description={an object that is launched into the air and moves under the influence of gravity alone}
}

\newglossaryentry{projectile motion}{
    name={projectile motion},
    description={the curved motion of a projectile as it moves both horizontally and vertically at the same time}
}
...
\newglossaryentry{apex}{
    name={apex},
    description={the highest point reached by a projectile during its flight}
}

\newglossaryentry{horizontally launched projectile}{
    name={horizontally launched projectile},
    description={a projectile that is launched parallel to the ground with no initial vertical velocity}
}

\newglossaryentry{impact speed}{
    name={impact speed},
    description={the speed of a projectile at the moment it strikes the ground}
}
...
\newglossaryentry{centripetal acceleration}{
    ...
    description={the acceleration directed toward the center of a circular path, responsible for changing the direction of an object's velocity}
}
...
\newglossaryentry{joule}{
    name=joule,
    description={the SI unit of energy and work, equal to one newton-meter
    }
}

\newglossaryentry{work}{
    name={work},
    description={the transfer of energy that occurs when a force is applied to an object over a displacement in the direction of the force}
}
...
\newglossaryentry{potential energy}{
    ...
    description={stored energy an object possesses due to its position or condition}
}

\newglossaryentry{gravitational potential energy}{
    name={gravitational potential energy},
    description={the stored energy an object possesses due to its height above a reference point}
}

\newglossaryentry{conservation of energy}{
...
\newglossaryentry{mechanical energy}{
    ...
    description={the sum of an object's kinetic energy and potential energy}
}

\newglossaryentry{conservation of mechanical energy}{
    name={conservation of mechanical energy},
    description={the total mechanical energy of a system remains constant as long as no non-conservative forces (such as friction) act on it}
}
...
\newglossaryentry{impulse}{
    name={impulse},
    description={the product of a force and the time over which it acts, }
}

\newglossaryentry{impulse-momentum theorem}{
    name={impulse-momentum theorem},
    description={impulse is equal to the change in momentum of an object}
}


\newglossaryentry{conservation of momentum}{
    name={conservation of momentum},
    description={the total momentum of a system remains constant as long as no net external force acts on it}
}

\newglossaryentry{elastic collision}{
    name={elastic collision},
    description={A collision in which both momentum and kinetic energy are conserved}
}

\newglossaryentry{inelastic collision}{
    name={inelastic collision},
    description={a collision in which momentum is conserved but kinetic energy is not.}
}


\newglossaryentry{perfectly inelastic collision}{
    name={perfectly inelastic collision},
    description={a collision in which the objects stick together after impact, resulting in the maximum loss of kinetic energy.}
}
