...
\newglossaryentry{motion map}{
    name={motion map},
    description={a diagram that represents the position and velocity of an object at equal time intervals}
}

\newglossaryentry{slope}{
    name={slope},
    description={the ratio of the vertical change to the horizontal change between two points on a line}
}
